...
@Component
public class TestNativePostgresSQLSearchContainer2 extends NativePostgresSQLSearchContainer {
    ...
    protected void initSearchExpressions(List<NativeSelectExpression> searchExpressions) {
        ...
        searchExpressions.add(NativeSelectExpression.of("id", nActorRight.resolveAttributePath(AppActorRight::getUuid)));
    }
}
