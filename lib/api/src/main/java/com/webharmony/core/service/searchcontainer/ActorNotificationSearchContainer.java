...
@Component
public class ActorNotificationSearchContainer extends AbstractQueryDslContainer<QAppActorNotification, UUID> {
    ...
    protected void initSearchExpressions(List<SearchQueryDslExpression<?, ?>> searchExpressions) {
        ...
        searchExpressions.add(SearchQueryDslExpression.of("recipient", qAppActorNotification.recipient.uniqueName));
