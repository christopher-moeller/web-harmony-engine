<template>
  <GenericResourceOverview :columns="columns" resource-name="webContentAreas"/>
</template>
...
const i18n = I18N.of("webContentAreas-index")

const columns:HarmonyTableColumn[] = [
  {
    id: "uniqueName",
    caption: i18n.translate("Unique Name").build(),
  },
  {
    id: "label",
  ...
  {
    id: "description",
    caption: i18n.translate("Description").build(),
  }
]
