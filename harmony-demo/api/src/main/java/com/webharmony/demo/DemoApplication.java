...
public class DemoApplication extends AbstractAppMain {

	public static void main(String[] args) {
		new DemoApplication()
				.prepare()
				.registerApiAuthorizationAnnotation(DemoApiAuthorization.class, a -> ApplicationAccessRule.of(a.value(), a.isOrConnected()))
				.run(args);
	}
	...
	public @interface DemoApiAuthorization{

		EDemoActorRights[] value();
		boolean isOrConnected() default false;

	}

	public enum EDemoActorRights implements PersistenceEnum<AppActorRight>, ApplicationRight {

		DEMO_TEST_RIGHT("Starter Test Right", "Starter Test Right"),
		...
		EDemoActorRights(String label, String description) {
			this.label = label;
